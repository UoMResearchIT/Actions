...
* [`get-pr-id`](get-pr-id) determines the PR for the current commit.
...
* [`secret-scanner`](secret-scanner) detects secrets such as API keys that have been inadvertently published.
